      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          {salsas.map((salsa, i) => (
            ...
            >
              ...
              >
                ...
                <a
                  href={`#tienda`}
                  className="inline-flex items-center gap-3 w-fit text-sm font-sans font-600 tracking-widest uppercase transition-all duration-300 group/link"
                  style={{ color: salsa.color }}
                >
                  Pedir esta salsa
        ...
        >
          ...
          <div className="bg-carbon p-10 lg:p-14 flex flex-col justify-center gap-6">
            ...
            <a
              href="#contacto"
              className="inline-flex items-center gap-3 w-fit px-8 py-4 bg-rojo text-crema font-bebas text-lg tracking-[0.2em] uppercase hover:bg-rojo-oscuro transition-colors duration-300"
            >
              Pedir el Kit
            </a>
          </div>
