...
const pasos = [
  {
    num: "01",
    titulo: "Fermentación probiótica",
    texto:
        ...
        <div className="max-w-7xl mx-auto px-6 pt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            >
              ...
              {/* Imagen proceso superpuesta — arriba a la derecha para no tapar el caption */}
              <motion.div
                initial={{ opacity: 0, y: -20, x: 20 }}
                animate={inView ? { opacity: 1, y: 0, x: 0 } : {}}
                transition={{ duration: 0.7, delay: 0.4 }}
                className="absolute -top-8 -right-4 w-36 h-36 border-2 border-carbon overflow-hidden hidden lg:block shadow-xl"
              >
                <Image
                  src="/images/matraz.jpg"
                  alt="Matraz de fermentación DOSIS"
                  fill
                  className="object-cover"
                />
              </motion.div>
            ...
            <div className="space-y-7 lg:pt-4">
              ...
              >
                ...
                frustraba: en Venezuela nadie se había atrevido a salirse
                del picante de siempre. Las mismas salsas, los mismos sabores
                predecibles.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <Image
                src="/images/matraz.jpg"
                alt="Matraz Erlenmeyer con salsa DOSIS en proceso de fermentación probiótica"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
              />
