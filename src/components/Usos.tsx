...
const usos = [
  ...
  },
  {
    ...
    copy: "En una empanada, en un pastelito, en una parrilla del domingo. El ahumado llega primero y te convence. El fuego llega después y te quedar.",
    imagen: "/images/uso-ahumadosis-v2.png",
    color: "#EA580C",
